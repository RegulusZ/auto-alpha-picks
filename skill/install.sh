...
echo "生产入口："
echo "  cd $TARGET"
echo "  python3 test_signal.py"
echo ""
echo "测试验证："
echo "  python3 test_signal.py --email-id=40   # SELL POWL"
echo "  python3 test_signal.py --email-id=45   # BUY LITE"
echo "  python3 test_signal.py --email-id=50   # 无信号"
echo ""
